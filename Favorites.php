    ...
    <body>
        ...
        <header class="bg-dark text-white py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1><i class="fas fa-bookmark " style="color:blue "></i></i> Favorites</h1>
                    </div>
                </div>
            </div>
        </header>
                ...
                ?>
                    ...
                    <?php
                        ...
                        $sql="SELECT DISTINCT artworks.ArtWorkID, artworks.ImageFileName, artworks.Title 
                        FROM artworks
                        LEFT JOIN reviews ON artworks.ArtWorkID=reviews.ArtWorkId 
                        WHERE reviews.Favorite='1' AND reviews.CustomerId=$CustomerID ";
                        ...
                        ?>
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 thumb text-center">
                                ...
                                <p><?php echo $artworkTitle;?></p>
                                    ...
                                    <form class="pb-2" action="Favorites.php" method="post">
                                        <a href="RemoveFromFav.php?id=<?php echo $artworkId ; ?>" >
                                        <span class="btn btn-success">Remove from List</span>
                                        </a>
                                    </form>
                                </div>
